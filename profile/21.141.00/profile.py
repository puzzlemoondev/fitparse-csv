...
# *********** EXPORTED PROFILE FROM SDK VERSION 21.141 ON 2024-06-11 ***********
# ********* PARSED 180 TYPES (3640 VALUES), 119 MESSAGES (1380 FIELDS) *********
...
MESSAGE_TYPES = {
    ...
    305: MessageType(  # User's current SpO2 data used for HSA custom data logging
        ...
        fields={
            ...
            1: Field(  # SpO2 Reading
                name='reading_spo2',
                type=BASE_TYPES[0x02],  # uint8
                def_num=1,
                units='percent',
            ),
            2: Field(  # SpO2 Confidence
                name='confidence',
                type=BASE_TYPES[0x02],  # uint8
                def_num=2,
            ),
    ...
    306: MessageType(  # User's current stress data used for HSA custom data logging
        ...
        fields={
            ...
            1: Field(  # Stress Level ( 0 - 100 ) -300 indicates invalid -200 indicates large motion -100 indicates off wrist
                name='stress_level',
                type=BASE_TYPES[0x01],  # sint8
                def_num=1,
                units='s',
    ...
    307: MessageType(  # User's current respiration data used for HSA custom data logging
        ...
        fields={
            ...
            1: Field(  # Breaths * 100 /min -300 indicates invalid -200 indicates large motion -100 indicates off wrist
                name='respiration_rate',
                type=BASE_TYPES[0x83],  # sint16
                def_num=1,
                scale=100,
    ...
    372: MessageType(  # Raw Beat-to-Beat Interval values
        ...
        mesg_num=372,
        fields={
            0: Field(  # ms since last overnight_raw_bbi message
                name='timestamp_ms',
                type=BASE_TYPES[0x84],  # uint16
                def_num=0,
                units='ms',
